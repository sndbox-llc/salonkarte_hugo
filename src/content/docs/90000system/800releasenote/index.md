...
### 2025/12/22 Version 6.1.7

- 定期メンテナンスを行いました。
- 内部的なお話になりますが、Android／iOSアプリに変換するCapacitorを7から8にアップデートしました
- Androidの方は最小OSがAndroid6からAndroid7に引き上げられました

### 2025/11/29 Version 6.1.6

- 定期メンテナンスを行いました。

### 2025/11/17 Version 6.1.5

- 新規アカウント作成時、挙動が若干不安定になるバグを修正しました
- 定期メンテナンスを実施しました

### 2025/10/16 Version 6.1.1
...
- [先行版はこちら](https://salonkarte-pre.web.app/)
...
- [Web版サロンカルテを開く](https://karte.hotaka-g.com/#/home/addkarte/new/login)
