...
title: サロンカルテ クイックスタートガイド：5分で始める超シンプル顧客管理
sidebar:
  label: 🔰クイックスタートガイド
...
![無料アカウント作成画面：メールとパスワードで登録](./img/signup_tablet.webp)
...
![顧客登録画面：お客様の基本情報を入力](./img/makeCustomer_tablet.webp)
...
![商品登録画面：施術メニューや商品をカテゴリ別に管理](./img/items_tablet.webp)
...
![カルテ作成開始：顧客番号で素早くアクセス](./img/inputDigit_tablet.webp)

![カルテ作成画面：写真・手書き・テキストで詳細を記録](./img/makeKarte_tablet.webp)
...
![カルテ一覧画面：すべてのカルテをリストで確認](./img/karteList_tablet.webp)

![過去のカルテを素早く呼び出すクイックボタン](./img/prevKarte_tablet.webp)
